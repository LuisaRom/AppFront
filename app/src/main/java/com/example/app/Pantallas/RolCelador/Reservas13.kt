...
@Composable
fun PantallaReservasCelador(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        ReservaCategoria(
            ...
            onReservaClick = { navController.navigate("PantallaReservaPiscinaCelador") }
        )
        ...
        ReservaCategoria(
            ...
            reservas = emptyList(), // vacía para mostrar mensaje
            onReservaClick = { navController.navigate("PantallaReservaSalonComunalCelador") }
        )
        ...
        ReservaCategoria(
            ...
            reservas = emptyList(),
            onReservaClick = { navController.navigate("PantallaReservaGimnasioCelador")}
        )
        ...
        ReservaCategoria(
            ...
            reservas = emptyList(), // vacía para mostrar mensaje
            onReservaClick = { navController.navigate("PantallaReservaZonaBBQCelador") }
        )
    }
}
@Composable
