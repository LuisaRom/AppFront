...
@Composable
fun PantallaReservaSalonComunal(navController: NavController) {
    ...
    var serviciosAdicionales by remember { mutableStateOf("") }
    val total = "$500.000"
    ...
    Column(
        ...
        CampoAcceso("Ingreso Peatonal", ingresoPeatonal) { ingresoPeatonal = it }
        CampoAcceso("Ingreso Vehicular", ingresoVehicular) { ingresoVehicular = it }
        CampoAcceso("Servicios Adicionales", serviciosAdicionales) { serviciosAdicionales = it }
        ...
        Button(
            onClick = {
                Toast.makeText(context, "Reserva salon comunal creada", Toast.LENGTH_SHORT).show()
            },
            modifier = Modifier
                .fillMaxWidth()
                .height(50.dp),
